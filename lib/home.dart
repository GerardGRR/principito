  ...
  Widget _buildSectionHeader(String title, String subtitle) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color(0xFF2A72A0))),
          Text(subtitle, style: const TextStyle(color: Color(0xFF5D9BBD), fontSize: 14)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            builder: (context, constraints) {
              ...
              return GridView.builder(
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  child: const Center(child: Icon(Icons.star_outline, color: Colors.black12, size: 50)),
                ),
              );
            }
          ),
          TextButton(
            onPressed: () {},
            child: const Text("Ver más productos", style: TextStyle(color: Color(0xFF5D9BBD), fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
